...
// TODO: These typedefs are only temporary
typedef QString Instruction_t;
#define MAX_LABEL_SIZE 256
namespace CapstoneTokenizer { typedef int SingleToken; };
typedef int DBGSTATE;
typedef int XREF_INFO;
...
protected:
    ...
    // TODO DisassemblyPopup mDisassemblyPopup;
